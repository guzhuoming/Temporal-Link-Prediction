...
# Compile model
model = Model(inputs=[X_in]+G, outputs=gcn)
...
data_pred.to_csv('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_12\\temporal link prediction_GCN\\prediciton_GCN.csv', index=False)
