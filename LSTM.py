...
for i in range(len(name_node_pairs)):
    ...
    file = open('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\temporal link prediction_12nodepairs_LSTM\\'+name_node_pairs[i]+'.csv','w',newline='')
...
for i in range(len(name_node_pairs)):
    ...
    file2 = open('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\temporal link prediction_12nodepairs_LSTM\\' + name_node_pairs[i] + '.csv')
    ...
    df_2.to_csv('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\temporal link prediction_12nodepairs_LSTM\\' + name_node_pairs[i] + '.csv', index=False)
