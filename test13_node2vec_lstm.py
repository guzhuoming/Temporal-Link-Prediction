...
model = Sequential()
model.add(Bidirectional(LSTM(units=50, input_shape=[ 739, 8], return_sequences=False))) #加不加biderectional好像没影响
...
data_pred.to_csv('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_12\\temporal link prediction_node2vec_LSTM\\prediciton_node2vec_LSTM.csv', index=False)
#-------------------
rmse = 0
