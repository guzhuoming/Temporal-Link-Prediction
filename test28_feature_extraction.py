...
for i in range(len(name_node_pairs)):
    ...
    file = open('./data/temporal link features_5_7days_739_17features/'+name_node_pairs[i]+'_temp_link_ft.csv','w',newline='')
...
for i in range(len(name_node_pairs)):
    ...
    for j in range(len(df_node_pair)):
        ...
        x = node_pair[0:npos]
        y = node_pair[npos+1:]
        file = open('./data/temporal link features_5_7days_739_17features/' + name_node_pairs[i] + '_temp_link_ft.csv')
        df = pd.read_csv(file)
        file.close()
        ...
        df.to_csv('./data/temporal link features_5_7days_739_17features/' + name_node_pairs[i] + '_temp_link_ft.csv', index=False)
