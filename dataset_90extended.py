...
file_ = open('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\name_node_pairs_2.csv','w',newline='') #2----包括二阶节点
...
df_set_1_hop_name.to_csv('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\1_hop_name.csv', index=False)
...
for i in range(len(set_1hop)):
    ...
    df_0_1.to_csv('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\0_1\\' + '0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be' + '_' + set_1hop[i] + '.csv')
    ...
    for j in range(len(set_2_hop)):
        ...
        df_1_2.to_csv('E:\\exchange_0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be_90\\1_2\\'+set_1hop[i]+'_'+set_2_hop[j]+'.csv')
